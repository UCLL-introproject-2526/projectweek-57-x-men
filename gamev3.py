...
# ---------------- PAYBAG / BROWSER COMPATIBILITY ----------------
# This allows the game to run both on desktop and in PAYBAG browser

# ---------------- BROWSER / PAYBAG ASYNC WRAPPER ----------------
import asyncio
import sys
from project.main import main_menu   # or wherever your game starts
